<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show {{ request()->routeIs('app.pos.*') ? 'c-sidebar-minimized' : '' }}" id="sidebar">
    <div class="c-sidebar-brand d-md-down-none">
        <a href="{{ route('home') }}">
            <img class="c-sidebar-brand-full p-2" src="{{ asset('images/logo.png') }}" alt="Site Logo" width="110">
            <img class="c-sidebar-brand-minimized p-2" src="{{ asset('images/logo.png') }}" alt="Site Logo" width="40">
            <label style="color: white">UD Keluarga Sehati</label>
        </a>
    </div>
